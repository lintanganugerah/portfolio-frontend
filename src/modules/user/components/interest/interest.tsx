export const Interest = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 px-6 lg:px-20">
      <div className="flex-1 flex flex-col justify-start items-center text-center lg:text-left space-y-4">
        <div className="flex md:flex-row flex-col items-center space-x-4">
          <div className="text-sm text-white">
            Tech stack that i've worked with, and or in learning
          </div>
        </div>
